...
function Nob1(x,y,z)
	...
	N = 1/r+2I/π
	Wi(t) = exp(z*(1+t^2))*sin((x+y*t)*hypot(1,t))
	J,_,m = quadgk_count(Wi,-Inf,Inf)
	W = 4J
	return N+W,n,m
end

# ╔═╡ d7e15e98-f696-4c16-92c8-0d7720aec245
function Nob1b(x,y,z)
	r = hypot(x,y,z)
...
function Nob3(x,y,z)
	r = hypot(x,y,z)
	Ni(t) = real(expintx(z*(1+t^2)+im*(x-abs(y)*t)*hypot(1,t)))
	I,_,n = quadgk_count(Ni,-Inf,Inf)
	N = 1/r+2I/π
	Wi(t) = exp(z*(1+t^2))*sin((x-abs(y)*t)*hypot(1,t))
	J,_,m = quadgk_count(Wi,x/abs(y),Inf)
	W = 4J
	return N+W,n,m
end
