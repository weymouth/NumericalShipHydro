...
begin
	Plots.scatter(inv.(data.N),data.drag,label = "drag", xlabel="1/N", 
		ylabel="force coefficient",xscale=:log10, xlims = (1e-3,0.1) ,ylims = (0,8e-3))
	Plots.scatter!(inv.(data.N),data.lift, label="lift")
end

# ╔═╡ cb56800d-5151-4143-9759-6e510089e4db
md"""
Our forces, especially the dynamic lift, depend strongly on the panel size. But the results have pretty much converged for `N>100` panels.
